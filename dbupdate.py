...
TABLES = ( "accounts", "accountsrole", "accountstrx", "activeuser", "additional", "additionalfield",
    ...
    "animalvaccination", "animalwaitinglist", "audittrail", "basecolour", "breed", "citationtype", "configuration", 
    "costtype", "customreport", "customreportrole", "dbfs", "deathreason", "diary", "diarytaskdetail", 
    "diarytaskhead", "diet", "donationpayment", "donationtype", "entryreason", "incidentcompleted", "incidenttype", 
    "internallocation", "licencetype", "lkcoattype", "lkownerflags", "lksaccounttype", "lksdiarylink", 
    "lksdonationfreq", "lksex", "lksfieldlink", "lksfieldtype", "lksize", "lksloglink", "lksmedialink", 
    "lksmediatype", "lksmovementtype", "lksposneg", "lksyesno", "lksynun", "lkurgency", "log", "logtype", 
    "media", "medicalprofile", "messages", "onlineform", "onlineformfield", "onlineformincoming", "owner", 
    "ownercitation", "ownerdonation", "ownerinvestigation", "ownerlicence", "ownertraploan", "ownervoucher", 
    "pickuplocation", "role", "species", "stocklevel", "stocklocation", "stockusage", "stockusagetype", "testtype", 
    "testresult", "traptype", "userrole", "users", "vaccinationtype", "voucher" )
...
def sql_default_data(dbo, skip_config = False):
    ...
    if not skip_config:
        ...
        sql += "INSERT INTO role VALUES (9, '" + _("Animal Control Officer", l) + "', 'aaci *caci *daci *vaci *aacc *cacc *dacc *vacc *')|=\n"
    ...
    sql += lookup2("entryreason", 13, _("Return From Foster", l))
    ...
    sql += lookup1("lksmovementtype", 13, _("Transport", l))
...
def update_3003(dbo):
    ...
    modify_column(dbo, "configuration", "ItemValue", "VARCHAR(16384)")

    ...
    def run(self):
        ...
        try:
            toremove = db.query(self.dbo, "SELECT a.ID, a.AnimalName, a.ShelterCode FROM animal a " \
                ...
                "WHERE ap.PublishedTo = 'meetapet' AND ap.SentDate Is Not Null AND " \
                "a.ID NOT IN (%s)" % ",".join(sentIds))
            ...
            try:
                ...
                try:
                    ...
                    if len(conversationid) == 0:
                        self.log("Could not parse conversation id, abandoning")
                        break
